# Allgemeines über Docker {#docker}
...
| **Isolierung** | 🟢 Sehr stark | 🟡 Kernel-geteilt |
...
!!! tip "🚀 Tipp für Einsteiger"
    Starte mit **Docker Compose**! Eine einfache `docker-compose.yml` reicht, um komplette Stacks *(Webserver + Datenbank + Reverse Proxy)* mit einem Befehl hochzufahren. Das ist der sweet spot zwischen Einfachheit und Power!
